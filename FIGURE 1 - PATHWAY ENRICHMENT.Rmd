...
MOUSE.ORTHOLOGS <- read.delim("/Volumes/Mac789_HD2/Publications/O'Meara et al., 2020/V5/GitHub/Annotation files/MOUSE.ORTHOLOGS.txt", stringsAsFactors=FALSE)
NODE_PATHWAY_ANNOTATION <- read.delim("/Volumes/Mac789_HD2/Publications/O'Meara et al., 2020/V5/GitHub/Annotation files/NODE_PATHWAY_ANNOTATION.txt", stringsAsFactors=FALSE)
MUTANT.LINE.LOG2.FC <- read.delim("/Volumes/Mac789_HD2/Publications/O'Meara et al., 2020/V5/GitHub/Annotation files/MUTANT.LINE.LOG2.FC.txt", stringsAsFactors=FALSE)
```

```{r setup, include=FALSE,tidy=TRUE, tidy.opts=list(width.cutoff=60)}
#HIDE SETWD
setwd("/Users/omeara/Desktop/R.wrk.dir/DEG lists/Unfiltered DEG/DESeq2/LINES/") 
